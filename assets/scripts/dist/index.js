...
var STORIES = [
    ...
    "The bus ride home wasn't too unusual for {Name}. {Subjective} heard a few people talking about {objective}. They said, \"I like {possDet} hair. I can't believe that's {possPro}. {Subjective} {seems/seem} like {subjective} {takes/take} care of {reflexive}.\"",
    "Hey! Come sit with us, {Name}! I'll introduce {objective}. {Subjective} {is/are} {Name}. {PossDet} interests are kinda the same as mine, hehe. Except, {subjective} {doesn't/don't} talk to {reflexive} like I do 😳. Anyway... I have some time later today. I'll probably hang out with {objective}. My time is all {possPro}.",
    "{Name} was the first to wake on Christmas morning. For a moment {subjective} felt {reflexive} as disappointed as {subjective} {was/were} long ago. Then {subjective} remembered {possDet} mother's promise and, slipping {possDet} hand under {possDet} pillow, drew out a little book. It was that beautiful story of the best life that could ever be {possPro}, and {Name} felt that it was a true guidebook for any pilgrim going on a long journey."
];
